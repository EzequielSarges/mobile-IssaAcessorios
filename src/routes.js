...
import produtos from './pages/admin/produtos/storeProdutos';
...
import storeImage from './pages/admin/produtos/storeImage'
    ...
    return(
        <NavigationContainer>
            <AppStack.Navigator screenOptions={{headerShown:false}} >
                ...
                <AppStack.Screen name="storeImage" component={storeImage}/>
            </AppStack.Navigator>
        </NavigationContainer>
    );
}
